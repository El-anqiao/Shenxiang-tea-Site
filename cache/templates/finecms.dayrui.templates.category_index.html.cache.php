	...
	<div class="portlet mylistbody">
		<div class="portlet-body">
			...
			<tr>
				...
				<th width="50"><?php echo fc_lang('Id'); ?></th>
				<th><?php echo fc_lang('名称'); ?></th>
				<th><?php echo fc_lang('目录'); ?></th>
				<th width="70" style="text-align: center"><?php echo fc_lang('类型'); ?></th>
				<th width="70" style="text-align: center"><?php echo fc_lang('模型'); ?></th>
			...
			<tr class="mtable_bottom">
				...
				<td colspan="99">
					...
					<button data-toggle="confirmation" id="dr_confirm_order" data-original-title="<?php echo fc_lang('排序按从小到大排列，最大支持99'); ?>" type="button" class="btn green btn-sm" name="option"> <i class="fa fa-edit"></i> <?php echo fc_lang('排序'); ?></button>
				</td>
			</tr>
			</tbody>
			</table>
