						...
						<div class="form-group r1">
							...
							<div class="col-md-9">
								<div class="radio-list">
									...
									<label class="radio-inline"><input type="radio" <?php if ($data['id']) { ?>disabled <?php } else { ?>onclick="dr_tid(1)"<?php } ?> name="data[tid]" value="1" <?php echo dr_set_radio('tid', $data['tid'], '1'); ?> /> <?php echo fc_lang('内容模型'); ?></label>
